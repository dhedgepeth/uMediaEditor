...
var jquery = {
  getLink: function (link, name) {
    //takes the media link and media name as parameters
...
$(document).ready(function () {
  ...
  function apply() {
    filters =
      ...
      "blur(" +
      $("#blurRange").val() / 6 +
      "px)"; //string variable holding filters and their values to be applied to the canvas context
